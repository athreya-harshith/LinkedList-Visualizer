...
int choice, item, key;
float color[6][3] = { {1.0, 1.0, 1.0}, {0.8, 0.0, 0.0}, {0.0, 0.0, 76.0}, {0.0, 0.0, 0.8},{104.0,0.0,165.0},{0.0,1.0,0.0} };
...
void dll_title()//To display contents of dll_first Window
{
    ...
    drawstring(130.0, 450.0, (char*)"RNS INSTITUTE OF TECHNOLOGY", 5, 2);
    drawstring(185.0, 400.0, (char*)"DEPARTMENT OF CSE", 5, 2);
    ...
    drawstring(0.0, 30.0, (char*)"    Harshith P Athreya [1RN20CS051]", 2, 0);
    drawstring(0.0, 10.0, (char*)"    Dheeraj M [1RN20CS041]", 2, 0);
    drawstring(425.0, 50.0, (char*)"Guided By:", 2, 0);
    drawstring(460.0, 30.0, (char*)"    Mrs.Mamatha Jajur S", 2, 0);
    drawstring(460.0, 10.0, (char*)"   Department of CSE,RNSIT ", 2, 0);
    glFlush();
}
